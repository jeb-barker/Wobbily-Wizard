...
<br><img align="left" src="/screenshots/Home.png" width="200"> 
 There will be a button next to their name that will send them a potion that they can use in battle once a day. This will adjust the corresponding variables in firebase and allow them to use a friend potion. <br>
